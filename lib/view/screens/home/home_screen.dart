...
import 'package:efood_multivendor_driver/view/screens/home/widget/shift_dialogue.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Future<void> _loadData() async {
    ...
    Get.find<AuthController>().getShiftList();
                        ...
                        if(GetPlatform.isAndroid) {
                          Get.dialog(ConfirmationDialog(
                            ...
                            onYesPressed: () {
                              Get.back();
                              _checkPermission(() {
                                if(authController.shifts != null && authController.shifts!.isNotEmpty) {
                                  Get.dialog(const ShiftDialogue());
                                }else{
                                  authController.updateActiveStatus();
                                }
                              });
        ...
        child: SingleChildScrollView(
          ...
          child: GetBuilder<AuthController>(builder: (authController) {
            ...
            return Column(children: [
              ...
              authController.profileModel != null ? Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: authController.profileModel!.cashInHands! > 0 && authController.profileModel!.earnings == 1 ? CrossAxisAlignment.start : CrossAxisAlignment.center,
                  children: [

                  Row(mainAxisAlignment: authController.profileModel!.cashInHands! > 0 && authController.profileModel!.earnings == 1 ? MainAxisAlignment.spaceBetween : MainAxisAlignment.center, children: [

                    Text(PriceConverter.convertPrice(authController.profileModel!.cashInHands), style: robotoBold.copyWith(fontSize: 30)),
                    const SizedBox(width: Dimensions.paddingSizeSmall),

                    (authController.profileModel!.cashInHands! > 0 && authController.profileModel!.earnings == 1) ? CustomButton(
                      width: 110, height: 40,
