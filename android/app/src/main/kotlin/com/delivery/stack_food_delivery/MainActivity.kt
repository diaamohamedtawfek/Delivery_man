package com.delivery.stack_food_delivery
...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(binaryMessenger, "com.delivery/background_service").apply {
        ...
        MethodChannel(binaryMessenger, "com.delivery/app_retain").apply {
            setMethodCallHandler { method, result ->
